...
(function () {
  ...
  const STRINGS = {
    "sv": {
      ...
      "f4Syn": "Från musik till digital konst, webbutveckling och workshops – ett fritt labb där idéer får testas innan de blir verklighet.",
      "f5Year": "Butik",
      "f5Type": "Merch · Tryck",
      ...
      "aboutShort2": "Jag föddes i nordöstra Syrien, i en torr region rik på mänsklig, språklig och kulturell mångfald. Det som präglade mig mest var värmen och omtanken hos dess folk. När kriget tvingade mig att lämna sökte jag skydd i Sverige, och där fick jag stöd, kunskap och förtroende av människor längs vägen. Efter de åren, och allt jag byggt här, började jag fundera på ett sätt att ge tillbaka — och så föddes STEP1FILM.",
      ...
      "bopStatus1": "Större delen av filmen är inspelad och en råklippning finns. Arbetet fortsätter med de sista klippningsrundorna fram till slutklippning.",
      "bopStatus2": "Vi söker finansiering för att färdigställa filmen och ta den genom postproduktionen. Parallellt sätter vi samman teamet som ska göra efterarbetet.",
      ...
      "bopSupportNames": "Film i Region Jönköping<br>Gaze ”Talent to Watch”<br>Längmanska kulturfonden",
      "bopTrailer": "Trailer",
      ...
      /* --- Jag som har två mammor (/Jagsomhartvamammor/) --- */
      "jhtmBack": "← Till startsidan",
      "jhtmKicker": "Dokumentärfilm · under utveckling · STEP1FILM",
      "jhtmUnder": "En dokumentärfilm av Ayman Hassdo.",
      "jhtmFStatus": "Status",
      "jhtmVStatus": "Under utveckling",
      "jhtmFPremiere": "Premiär",
      "jhtmVPremiere": "Beräknad 2028",
      "jhtmFFormat": "Format",
      "jhtmVFormat": "Dokumentärfilm",
      "jhtmFDirector": "Regi",
      "jhtmHeroTri": "Andra delen i en trilogi om migration och integration. Birds of Passage är den första, och den tredje kommer att heta Där och Här, Då och Nu.",
      "jhtmFilmHead": "Filmen",
      "jhtmFilm1": "Två kvinnor. En biologisk mamma på andra sidan jordklotet, och en som kom in i familjen och stannade.",
      "jhtmFilm2": "Filmen utforskar hur oväntade band kan bli de starkaste — och vad två mammor gör med en berättelse om tillhörighet.",
      "jhtmTriHead": "En trilogi",
      "jhtmTriSub": "om migration och integration",
      "jhtmTri1": "Jag som har två mammor är den andra filmen jag arbetar med, efter Birds of Passage, i en trilogi med annorlunda och unika perspektiv på migration och integration. Filmerna skildrar människan som människa — inte som en fråga.",
      "jhtmFedaa": "Min mamma. Kriget och regimen skilde oss åt, och det vi har kvar är samtal över tidszoner och besök som tar slut. I filmen är hon både närvarande och långt borta.",
      "jhtmBirgitta": "Birgitta kom in i mitt liv som stödperson till mina döttrar. Med åren har hon blivit en slags modersfigur — för mig och för mina två döttrar.",
      "jhtmDistHead": "Avståndet",
      "jhtmDist1": "Min biologiska mamma Fedaa hamnade i Australien efter kriget i Syrien. Familjen finns kvar — men på andra sidan jordklotet.",
      "jhtmQuestion": "Vad betyder familj när man förlorat sitt ursprung?",
      "jhtmStatusHead": "Status och process",
      "jhtmStatus1": "Projektet är i en utforskande fas — jag samlar material. Jag vet vad jag vill säga, men låter filmen växa fram i sin egen takt.",
      "jhtmStatus2": "Research och utveckling sker med Sydsvenska Filmkreatörer. Premiären är beräknad till 2028.",
      "jhtmDirHead": "Regissören",
      "jhtmDirName": "Regi och produktion",
      "jhtmDirBase": "Bas",
      "jhtmDirBaseV": "Skillingaryd, Sverige",
      "jhtmDirCompany": "Bolag",
      "jhtmDirEdu": "Utbildning",
      "jhtmDirEduV": "Dokumentärfilm, Ölands folkhögskola",
      "jhtmDirProg": "Program",
      "jhtmDirProgV": "GAZE ”Talent to Watch”, Jönköpings län<br>Bergman Talangdagar",
      "jhtmDirBio": "Filmregissör i Sverige sedan 2013, kommer från Syrien. Driver produktionsbolaget STEP1FILM.",
      "jhtmContact": "Skriv till Ayman",
      "jhtmContactNote": "Frågor om filmen, utveckling eller samarbete.",
      "ctaRead": "Läs om",
      "readAria": "Läs om Birds of Passage",
      "readAria2": "Läs om Jag som har två mammor",
    ...
    "en": {
      ...
      "f4Type": "Digital lab",
      "f4Title": "STEP<em>1</em> DIGITAL LAB",
      "f4Syn": "From music to digital art, web development and workshops — a free lab where ideas get tested before they become reality.",
      "f5Year": "Store",
      "f5Type": "Merch · Print",
      ...
      "aboutShort2": "I was born in north-eastern Syria, in an arid region rich in human, linguistic and cultural diversity. What shaped me most was the warmth and the care of its people. When war forced me to leave I found refuge in Sweden, and there I was given support, knowledge and trust by people along the way. After those years, and everything I have built here, I started thinking of a way to give back — and that is how STEP1FILM came to be.",
      ...
      "bopStatus1": "The majority of the film has been shot and a rough cut is in place. Work continues through the final rounds of editing towards the final cut.",
      "bopStatus2": "We are seeking funding to complete the film and take it through post-production. In parallel we are assembling the team who will carry out that work.",
      ...
      /* --- The One With Two Mothers (/Jagsomhartvamammor/) --- */
      "jhtmBack": "← Back to start",
      "jhtmKicker": "Documentary · in development · STEP1FILM",
      "jhtmUnder": "A documentary by Ayman Hassdo.",
      "jhtmFStatus": "Status",
      "jhtmVStatus": "In development",
      "jhtmFPremiere": "Premiere",
      "jhtmVPremiere": "Estimated 2028",
      "jhtmFFormat": "Format",
      "jhtmVFormat": "Documentary",
      "jhtmFDirector": "Director",
      "jhtmHeroTri": "The second part of a trilogy on migration and integration. Birds of Passage is the first, and the third will be called Där och Här, Då och Nu.",
      "jhtmFilmHead": "The film",
      "jhtmFilm1": "Two women. A birth mother on the other side of the world, and one who came into the family and stayed.",
      "jhtmFilm2": "The film explores how unexpected bonds can become the strongest — and what two mothers do to a story about belonging.",
      "jhtmTriHead": "A trilogy",
      "jhtmTriSub": "on migration and integration",
      "jhtmTri1": "The One With Two Mothers is the second film I am working on, after Birds of Passage, in a trilogy of unusual and singular perspectives on migration and integration. The films portray the human being as a human being — not as an issue.",
      "jhtmFedaa": "My mother. The war and the regime separated us, and what we have left are conversations across time zones and visits that come to an end. In the film she is both present and far away.",
      "jhtmBirgitta": "Birgitta came into my life as a support person for my daughters. Over the years she has become a kind of mother figure — for me and for my two daughters.",
      "jhtmDistHead": "The distance",
      "jhtmDist1": "My birth mother Fedaa ended up in Australia after the war in Syria. The family is still there — but on the other side of the world.",
      "jhtmQuestion": "What does family mean when you have lost your origin?",
      "jhtmStatusHead": "Status and process",
      "jhtmStatus1": "The project is in an exploratory phase — I am gathering material. I know what I want to say, but I am letting the film grow at its own pace.",
      "jhtmStatus2": "Research and development is carried out with Sydsvenska Filmkreatörer. The premiere is estimated for 2028.",
      "jhtmDirHead": "The director",
      "jhtmDirName": "Director and producer",
      "jhtmDirBase": "Based in",
      "jhtmDirBaseV": "Skillingaryd, Sweden",
      "jhtmDirCompany": "Company",
      "jhtmDirEdu": "Education",
      "jhtmDirEduV": "Documentary film, Ölands folkhögskola",
      "jhtmDirProg": "Programmes",
      "jhtmDirProgV": "GAZE ”Talent to Watch”, Jönköping County<br>Bergman Talent Days",
      "jhtmDirBio": "Film director in Sweden since 2013, originally from Syria. Runs the production company STEP1FILM.",
      "jhtmContact": "Write to Ayman",
      "jhtmContactNote": "Questions about the film, development or collaboration.",
      "ctaRead": "Read more",
      "readAria": "Read about Birds of Passage",
      "readAria2": "Read about The One With Two Mothers",
