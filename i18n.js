...
(function () {
  ...
  const STRINGS = {
    sv: {
      ...
      /* Underrubriken under märket. Står oöversatt med flit — det är en
         devis, inte en mening, och den ska se likadan ut på båda språken. */
      ...
      f2Syn: 'En film under research och utveckling.',
      ...
      /* Knapparna längst till höger på panel 02 */
      ...
      /* --- Panel 04: Press --- */
      p4Title: 'CV',
      p4Meta: 'Filmer · Festivaler · Stöd · Utvald av',
      cvFilms: 'Filmer',
      cvFestivals: 'Festivaler',
      cvSupport: 'Stöd',
    ...
    en: {
      ...
      f2Syn: 'A film under research and development.',
      ...
      /* The buttons on the far right of panel 02 */
      ctaWatch: 'Watch',
      ctaFilms: 'Films',
      ctaSoon: 'Soon',
      ...
      p4Title: 'CV',
      p4Meta: 'Films · Festivals · Support · Selected by',
      cvFilms: 'Films',
      cvFestivals: 'Festivals',
      cvSupport: 'Support',
