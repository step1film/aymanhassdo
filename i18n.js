...
(function () {
  ...
  const STRINGS = {
    sv: {
      ...
      cvSchool: 'Utbildning',
      cvEd1: 'Samordning och projektansökningar · distans',
      cvEd2: 'Filmfoto · distans',
      cvEd3: 'Dokumentärfilm',
      cvEd6: 'Komposition',
      ...
      /* --- Panel 04: Press --- */
      p4Title: 'CV',
      p4Meta: 'Utbildning · Erfarenhet · Filmografi',
      cvExperience: 'Erfarenhet',
      cvFilmography: 'Filmografi',
      cvRuntime: 'Speltid',
    ...
    en: {
      ...
      cvSchool: 'Education',
      cvEd1: 'Coordination and grant applications · distance',
      cvEd2: 'Cinematography · distance',
      cvEd3: 'Documentary film',
      cvEd6: 'Composing',
      ...
      p4Title: 'CV',
      p4Meta: 'Education · Experience · Filmography',
      cvExperience: 'Experience',
      cvFilmography: 'Filmography',
      cvRuntime: 'Runtime',
