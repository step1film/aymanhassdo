...
(function () {
  ...
  const STRINGS = {
    "sv": {
      ...
      "aboutP3": "STEP1FILM är en plattform för att stötta nästa generations filmskapare i deras första projekt, och en mötesplats för dem som söker kontakt med konstnärer och tekniker inom filmbranschen — för att hjälpa dem genom resan att producera sin första film, från idé till distribution på biografer och festivaler.",
      ...
      "aw6d": "Kontakt med de filmarbetare din vision behöver.",
      "p4Title": "CV",
    ...
    "en": {
      ...
      "aw2d": "From a first note to a screenplay that holds up.",
      "aw3": "Shoot your film",
