...
(function () {
  ...
  const STRINGS = {
    "sv": {
      ...
      "contactIntro": "Genom våra kontakter kan vi hjälpa dig att boka föreläsare, ordna workshops eller utveckla kulturella appar. Har du något annat på gång — eller bara en fråga som inte riktigt passar in någon annanstans? Skriv ändå, så hör vi av oss.",
      "cfName": "Namn",
      "cfEmail": "E-post",
    ...
    "en": {
      ...
      "contactIntro": "Through our network we can help you book speakers, arrange workshops or develop cultural apps. Something else in the works — or just a question that doesn’t quite fit anywhere else? Write anyway, and we’ll get back to you.",
      "cfName": "Name",
      "cfEmail": "Email",
