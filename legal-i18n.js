...
(function () {
  ...
  const EN = {
    ...
    fl8: 'Shipping is calculated at checkout based on what you order and where it is going, and is always shown before you pay. If it comes to less than SEK 79 you pay the lower price — you never pay more than SEK 79. The free-shipping threshold is calculated on the total price of the items, before shipping.',
    fl9: 'Delivery time',
